            ...
            <div class="left_col scroll-view">
                ...
                <div class="profile clearfix">
                    <div class="profile_pic">
                        <img src="http://localhost/haber/<?php echo $kullanicicek['kullanici_resim'];?>" alt="..." class="img-circle profile_img">
                    </div>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="">
                            <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                <img src="http://localhost/haber/<?php echo $kullanicicek['kullanici_resim'];?>" alt=""><?php echo $_SESSION['kullanici_ad'];?>
